...
<div class="panel panel-default" id="div-panel-gestion">
              <div class="panel-heading" id="title-panel-regform">
                    <h3 class="panel-title"><h3><span class="glyphicon glyphicon-briefcase"></span>&nbsp; Estado de Solicitudes Persona Natural</h3>
<hr/></h3>
              </div>
  ...
  <table class="table table-bordered table-condensed" id="tabla_lista_paises">
    ...
    <tbody>
                   ...
                   {
                               if($datos[$i]['tipo_solicitud'] != "PERSONA NATURAL")
                               {
                                 continue;
                               }
                               echo '<tr>';
