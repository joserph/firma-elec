                        ...
                        <!--<div class="col-md-12">-->
                           <input type="hidden" name="tipo_solicitud" class="form-control" value="3">
                              ...
                              <div class="form-group col-md-4" id="g_empresa">
                                 ...
                                 <span id="error_empresa" class="help-block ocultar"><small>El campo es requerido y debe ingresar nombre, tal como está registrado en el RUC</small></span>
                                 </div>
                              </div>
                              ...
                              <div class="form-group col-md-4" id="g_cargo">
                                 ...
                                 <span id="error_cargo" class="help-block ocultar"><small>El campo es requerido y debe ingresar nombre, es el cargo que ocupa en la empresa la persona firmante</small></span>
                                 </div>
                              </div>
                              <div class="form-group col-md-6" id="g_motivo">
                                 ...
                                 <span id="error_motivo" class="help-block ocultar"><small>El campo es requerido</small></span>
                                 </div>
                              </div>
                              <div class="form-group col-md-6" id="unidad">
                                 ...
                                 <span id="error_unidad" class="help-block ocultar"><small>El campo es requerido</small></span>
                                 </div>
                              </div>
                              <!-- END -->
                              ...
                              <div class="form-group col-md-6" id="g_nombresRL">
                                 ...
                                 <span id="error_nombresRL" class="help-block ocultar"><small>El campo es requerido y no acepta números ni caracteres especiales</small></span>
                                 </div>
                              </div>
                              <div class="form-group col-md-6" id="g_apellidosRL">
                                 ...
                                 <span id="error_apellidosRL" class="help-block ocultar"><small>El campo es requerido y no acepta números ni caracteres especiales</small></span>
                                 </div>
                              </div>
                              ...
                              <tr>
                                  <td>
                                    <div class="form-group col-md-11" id="g_f_documentoRL">
                                        ...
                                        <input type="file" name="f_documentoRL" id="f_documentoRL" class="form-control" required onchange="validateInputFilePdf('f_documentoRL')">
                                        </div>
                                    </div>
                                  </td>
                              ...
                              <tr>
                                  <td>
                                    <div class="form-group col-md-11" id="g_f_autreprelegal">
                                        ...
                                        <input type="file" name="f_autreprelegal" id="f_autreprelegal" class="form-control" required onchange="validateInputFilePdf('f_autreprelegal')">
                                        </div>
                                    </div>
                                  </td>
