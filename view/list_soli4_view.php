...
<div class="panel panel-default" id="div-panel-gestion">
              <div class="panel-heading" id="title-panel-regform">
                    <h3 class="panel-title"><h3><span class="glyphicon glyphicon-briefcase"></span>&nbsp; Estado de Solicitudes Miembro de Empresa</h3>
<hr/></h3>
              </div>
  ...
  <table class="table table-bordered table-condensed" id="tabla_lista_paises">
    ...
    <tbody>
                   ...
                   {
                               if($datos[$i]['tipo_solicitud'] != "MIEMBRO DE EMPRESA")
                               {
                                 continue;
                               }
                               echo '<tr>';
